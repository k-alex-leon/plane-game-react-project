...
Command: npx gltfjsx@6.2.10 plane.glb 
...
import { useGLTF, useAnimations, Gltf, useScroll } from "@react-three/drei";
import { useFrame } from "@react-three/fiber";
import { Matrix4, Quaternion, Vector3 } from "three";
import { updatePlaneAxis } from "./assets/controls";

// SOUND EFFECT
import plane from "/audio/planeSound.mp3";
...
export function Plane(props) {
  // const [planeSound] = useSound(plane, { soundEnabled: true, volume: 0.2 });
  const group = useRef();
  ...
  useFrame(({ camera }) => {
    ...
    // config para dar delay a la camara y el mov del avion
    ...
    const cameraMatrix = new Matrix4()
      ...
      // update de la camera pos
      .multiply(delayedRotMatrix)
      // cambiando el angulo de camara
      .multiply(new Matrix4().makeRotationX(-0.2))
      // pos final (la parte trasera del avion)
